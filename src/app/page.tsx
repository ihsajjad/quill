...
import previewImg from "/public/dashboard-preview.jpg";
// import previewImg from "../../public/dashboard-preview.jpg";

export default function Home() {
  return (
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex items-center justify-center flex-col text-center">
        ...
        <p className="mt-5 max-w-prose text-zyinc-700">
